...
// Fungsi untuk menambahkan nilai pada bagian depan deque
...
// Fungsi untuk menambahkan nilai pada bagian belakang deque
...
// Fungsi untuk mendapatkan nilai pada bagian depan deque
void getfront() {
    if (f == -1 && r == -1) {
        printf("Deque kosong");
    } else {
...
// Fungsi untuk mendapatkan nilai pada bagian belakang deque
void getrear() {
    if (f == -1 && r == -1) {
        printf("Deque kosong");
    } else {
