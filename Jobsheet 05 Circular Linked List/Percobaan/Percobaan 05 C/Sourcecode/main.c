...
#include <stdlib.h>
#include <malloc.h>
#include <conio.h> // Libreri 'conio.h' hanya tersedia di sistem Windows,
//mungkin tidak kompatibel dengan semua kompiler atau lingkungan pengembangan
...
// Fungsi untuk menambahkan node sebelum node tertentu dalam linked list
struct node *insert_before(struct node *);

// Fungsi untuk menambahkan node setelah node tertentu dalam linked list
...
// Fungsi untuk menghapus node tertentu dalam linked list
struct node *delete_node(struct node *);

// Fungsi untuk menghapus node setelah node tertentu dalam linked list
...
int main(int argc, char *argv[]) {
    ...
    getch(); // Menunggu input karakter sebelum keluar dari program
    return 0;
}
